...
import KitStatusPoller from "@/components/KitStatusPoller";
...
type KitRecord = {
  ...
  kit: {
    ...
    flashcards: Array<{ id: string; question: string; answer: string; requirementIds: string[] }>;
    schedule: Array<{ day: number; focus: string; minutes: number }>;
  } | null;
  practiceProgress: Record<string, { confidence: number | null; completed: boolean }>;
};
