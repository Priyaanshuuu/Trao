...
// Validate ../../app/api/practice/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/practice/[id]">> = Specific
  const handler = {} as typeof import("../../app/api/practice/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
